...
A simple command-line interface for cracking passwords. It is setup to crack salted SHA256  passwords with dictionary and hybrid attacks, but can be easily modified. One can easily change the hashfunction, the salt position, and write new attacks.
